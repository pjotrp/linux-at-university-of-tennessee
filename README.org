...
To receive mail choose IMAP, servername 'localhost' and port 1143 with your UTHSC email as user name. Next, set connection security to 'None' and password submitted insecurely.
...
Next set up sending E-mail in the 'Outgoing Server' dialog. I added a new server with settings server name 'localhost', port 1025, connection security 'None', password sent insecured and username my UTHSC email again.
